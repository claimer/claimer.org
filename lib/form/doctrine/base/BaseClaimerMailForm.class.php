...
/**
 * ClaimerMail form base class.
 *
 * @method ClaimerMail getObject() Returns the current form's model object
 *
 * @package    claimer
 * @subpackage form
 ...
 */
abstract class BaseClaimerMailForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'recipients_label' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'recipients_label' => new sfValidatorString(array('max_length' => 255)),
    ...
    $this->widgetSchema->setNameFormat('claimer_mail[%s]');
