...
/**
 * ClaimerValue filter form base class.
 *
 * @package    claimer
 * @subpackage filter
 ...
 */
abstract class BaseClaimerValueFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('claimer_value_filters[%s]');
